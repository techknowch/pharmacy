            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#userManagement" data-bs-toggle="collapse" role="button"
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#medicineGeneric" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="medicineGeneric">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#medicineSupplier" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="medicineSupplier">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#medicineOrder" data-bs-toggle="collapse" role="button"
                                aria-expanded="false" aria-controls="medicineOrder">
                                <i class="ri-pages-line"></i> <span data-key="t-pages">Medicine Order</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#productExpiry" data-bs-toggle="collapse" role="button"
                                aria-expanded="false" aria-controls="productExpiry">
                                <i class="ri-pages-line"></i> <span data-key="t-pages">Product Expiry Info</span>
                            </a>
                            <div class="collapse menu-dropdown" id="productExpiry">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="pages-starter.html" class="nav-link" data-key="t-starter"> Starter </a>
                                    </li>
