        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Medicines List</h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <a href="{{ route('medicines.create') }}" class="btn btn-success" id="addproduct-btn"><i class="ri-add-line align-bottom me-1"></i>Add Medicine</a>
                    </div><!-- end card header -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hstack gap-3 flex-wrap">
                                            ...
                                            <a href="javascript:void(0);" class="link-danger fs-15 delete-category" data-id="{{ $medicine->id }}" data-confirm="Are you sure you want to delete this medicine?">
