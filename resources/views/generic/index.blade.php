            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <a href="{{ route('medicine-generics.create') }}" class="btn btn-success" id="addproduct-btn"><i class="ri-add-line align-bottom me-1"></i>Add Medicine Generic</a>
                    </div><!-- end card header -->
            ...
            link.addEventListener("click", function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        fetch(`/medicine-generics/${categoryId}`, {
                                method: "DELETE",
                                headers: {
                            ...
                            .then(data => {
                                if (data.success) {
                                    Swal.fire({
                                        title: "Deleted!",
                                        text: "Your generic category has been deleted.",
                                        icon: "success",
                                    ...
                                    Swal.fire({
                                        title: "Error!",
                                        text: "Failed to delete the generic category.",
                                        icon: "error",
                                        confirmButtonClass: "btn btn-primary w-xs mt-2",
                                        buttonsStyling: false,
                                    });
